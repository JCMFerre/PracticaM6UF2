...
public class LoginPrincipalGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        iniciarSessioButton.setText("Inciar sessió");
    ...
    private void iniciarSessio(java.awt.event.ActionEvent evt) {                               
        lanzarAccion(true);
    }                              
    ...
    private void lanzarInicioSesion() {
        ...
        if (validacion == 1) {
            ...
            lanzarMensajeEmergente(true, validacion == 0
                    ? "L'usuari existeix pero la contrasenya es incorrecte"
                    : "Error, no existeix l'usuari.");
        }
    }

    private void netejarCamps(java.awt.event.ActionEvent evt) {                              
        usuariTextField.setText("");
        contrasenaPasswordField.setText("");
        ponerFocoLogin();
    }                             

    private void registrarUsuari(java.awt.event.ActionEvent evt) {                                 
        lanzarAccion(false);
    }                                
    ...
    private void lanzarAccion(boolean iniciarSesion) {
        if (comprobarCampos()) {
            if (cambiarEntity()) {
                ...
                lanzarMensajeEmergente(true, "Error amb la connexió, asegurat que tot esta correcte.");
            }
        } else {
            lanzarMensajeEmergente(true, "Comprova que cap dels camps esta buit.");
        }
    }
    ...
    private void lanzarRegistroUsuario() {
        ...
        lanzarMensajeEmergente(!insertadoCorrectamente, insertadoCorrectamente
                ...
                : "No s'ha pogut inserir l'usuari, ja exiteix un usuari amb aquest nom.");
    }
    ...
    /**
     *
     * @return true si utiliza externa, false interna.
     */
    ...
    private boolean comprobarCampos() {
        return usuariTextField.getText() != null && !usuariTextField.getText().isEmpty()
                ...
                && contrasenaPasswordField.getPassword().length > 0;
    }
